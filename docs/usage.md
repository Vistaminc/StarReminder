...
```json
{
  ...
  "Alert": {
    ...
    "NotificationTitle": "游戏时间提醒",
    "NotificationMessage": "已游戏1小时，该休息了",
    "EnableContinuousAlert": true,
    "WatermarkText1": "游戏时间: {runtime}",
    "WatermarkText2": "请注意休息",
...
```json
{
  ...
  "Alert": {
    ...
    "NotificationTitle": "敏感应用启动通知",
    "NotificationMessage": "已记录到审计日志",
...
```json
{
  ...
  "Alert": {
    ...
    "NotificationMessage": "检测到屏幕录制，即将终止",
    "EnableContinuousAlert": true,
    "WatermarkText1": "⚠️ 警告",
    "WatermarkText2": "检测到屏幕录制",
    "WatermarkPosition": "TopRight",
...
<div align="center">
  <sub>需要帮助？访问 <a href="https://github.com/yourusername/StarReminder/wiki">Wiki</a> 或提交 <a href="https://github.com/yourusername/StarReminder/issues">Issue</a></sub>
</div>
